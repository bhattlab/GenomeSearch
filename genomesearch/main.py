...
@click.pass_context
def cli(ctx, fasta, num_markers, outdir, prefix, force, threads, max_target_seqs, keep_intermediate, fasta_type):
...
def refbank(ctx):
    ...
    log_params(fasta=ctx.obj['fasta'], num_markers=ctx.obj['num_markers'], outdir=ctx.obj['outdir'],
               prefix=ctx.obj['prefix'], force=ctx.obj['force'], threads=ctx.obj['threads'],
               max_target_seqs=ctx.obj['max_target_seqs'], keep_intermediate=ctx.obj['keep_intermediate'],
               meta=ctx.obj['meta'], fasta_type=ctx.obj['fasta_type'])

    if not ctx.obj['meta']:
        _refbank(ctx.obj['fasta'], ctx.obj['num_markers'], ctx.obj['outdir'],
               ctx.obj['prefix'], ctx.obj['force'], ctx.obj['threads'],
               ctx.obj['max_target_seqs'], ctx.obj['keep_intermediate'],
               ctx.obj['meta'], ctx.obj['fasta_type'])
    else:
        _refbank_meta(ctx.obj['fasta'], ctx.obj['num_markers'], ctx.obj['outdir'],
                 ctx.obj['prefix'], ctx.obj['force'], ctx.obj['threads'],
                 ctx.obj['max_target_seqs'], ctx.obj['keep_intermediate'],
                 ctx.obj['meta'], ctx.obj['fasta_type'])
...
def uhgg(ctx):
    ...
    _uhgg(ctx.obj['fasta'], ctx.obj['num_markers'], ctx.obj['outdir'],
             ctx.obj['prefix'], ctx.obj['force'], ctx.obj['threads'],
             ctx.obj['max_target_seqs'], ctx.obj['keep_intermediate'],
             ctx.obj['meta'], ctx.obj['fasta_type'])
